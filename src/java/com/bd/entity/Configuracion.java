...
@NamedQueries({
    ...
    , @NamedQuery(name = "Configuracion.findByCorreo", query = "SELECT c FROM Configuracion c WHERE c.correo = :correo")})
public class Configuracion implements Serializable {
    ...
    public Configuracion(Integer id, String nombre, String telefono, String direccion, String correo) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "com.bd.entity.Configuracion[ id=" + id + " ]";
    }
