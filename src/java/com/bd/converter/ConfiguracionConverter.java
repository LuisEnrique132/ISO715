...
@FacesConverter(value = "configuracionConverter")
public class ConfiguracionConverter implements Converter {

    private ConfiguracionFacade ejbFacade;
    ...
    private ConfiguracionFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(ConfiguracionFacade.class).get();
