...
@FacesConverter(value = "editorialConverter")
public class EditorialConverter implements Converter {

    private EditorialFacade ejbFacade;
    ...
    private EditorialFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(EditorialFacade.class).get();
